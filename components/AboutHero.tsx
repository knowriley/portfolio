    ...
    <section className="flex justify-center px-5 md:px-10 lg:h-[calc(100dvh-64px)]">
      <div className="max-w-page w-full flex flex-col">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4 lg:mt-auto pt-10 lg:pt-0">
          <span className="about-label-mobile text-body-small md:text-body-big text-text-primary mr-1">About Riley, for</span>
          {audiences.map((a, i) => (
            <FilterPill
              key={a.label}
              label={a.label}
        ...
        <h1 className="about-message-mobile text-h3 md:text-h2 lg:text-display font-normal text-text-primary pb-10 lg:pb-[4.95vw]">
